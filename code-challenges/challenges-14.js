...
const LastWord = (str) => {
    ...
    return word.slice(word.lastIndexOf()).join(' ')
    }
...
const LastWord_2 = (str) => {
    ...
    return word.slice(word.length-1).join('')
    }
...
const replaceWords = (str) => {
    ...
    if (str.indexOf("I")>= 0) {
        arrOfString.splice(str.indexOf('I'), 1, "We");
    }  
  
    if (str.indexOf("was") >= 0) {
        arrOfString.splice(str.indexOf("was") - 1, 1, "were");
    }

    if (str.indexOf("am") >= 0) {
        arrOfString.splice(str.indexOf("am") - 1, 1, "are");
    }
